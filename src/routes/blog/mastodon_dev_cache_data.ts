...
export const mastodon_dev_cache_data: Array<[Url, Fetch_Value_Cache_Item]> = [
	[
		'GET::https://mastodon.social/api/v1/statuses/112791910038764650/context',
		{
			key: 'GET::https://mastodon.social/api/v1/statuses/112791910038764650/context',
			url: 'https://mastodon.social/api/v1/statuses/112791910038764650/context',
	...
	[
		'GET::https://mastodon.social/api/v1/statuses/112791910038764650',
		{
			key: 'GET::https://mastodon.social/api/v1/statuses/112791910038764650',
			url: 'https://mastodon.social/api/v1/statuses/112791910038764650',
			value: {
				...
				media_attachments: [],
				mentions: [],
				tags: [{name: 'sveltekit', url: 'https://mastodon.social/tags/sveltekit'}],
				emojis: [],
				card: {
